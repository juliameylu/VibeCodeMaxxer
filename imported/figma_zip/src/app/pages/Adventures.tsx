...
import {
  Plus, Users, Hash, Copy, Share2, ArrowLeft, Check, Trash2, Crown,
  Link as LinkIcon, MessageSquare, X, MapPin, Clock, Car, Calendar,
  Leaf, Mountain, TreePine, ChevronRight, Navigation, AlertCircle
} from "lucide-react";
...
export function Adventures() {
  ...
  const handleCopyLink = (adv: Adventure) => {
    navigator.clipboard.writeText(getJoinLink(adv.friendCode));
