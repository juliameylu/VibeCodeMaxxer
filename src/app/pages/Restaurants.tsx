...
export function Restaurants() {
  ...
  const [bookingInfoSubmitted, setBookingInfoSubmitted] = useState(false);
  ...
  async function onBookReservation() {
    if (!selectedPlace || !selectedSlotId || !bookingInfoSubmitted) return;
          ...
          <section className="rounded-2xl border border-[#F2E8CF]/25 bg-[#F2E8CF]/8 backdrop-blur-md p-3 space-y-3">
            ...
            <div>
              ...
              <button
                ...
                className="mt-2 px-3 py-2 rounded-xl text-[10px] font-black uppercase tracking-wider bg-white/10 border border-white/20 text-white/85"
              >
                Submit booking info
              </button>
              {!bookingInfoSubmitted ? (
                <p className="mt-1 text-[11px] text-white/45">Submit booking info before confirming a slot.</p>
              ) : null}
            </div>
              ...
              <>
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <button
                    ...
                    disabled={!selectedReservationSlot || reservationLoading || !bookingInfoSubmitted}
