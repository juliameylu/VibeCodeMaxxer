        ...
        {open && (
          <motion.div
            ...
            style={{
              ...
              bottom: "calc(var(--app-nav-bottom-offset, 0px) + 80px)",
            }}
          >
            {/* Header */}
            <div className="flex items-center justify-between px-4 py-3 border-b border-white/10">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="text-[10px] text-[#F2E8CF] font-bold bg-[#F2E8CF]/10 px-2.5 py-1 rounded-full"
                >
                  Full Chat
                </button>
                ...
                <div key={i}>
                  ...
                  {msg.path && msg.role === "bot" && (
                    <button
                      ...
                      className="flex items-center gap-1 text-[10px] font-bold text-[#F2E8CF] bg-[#F2E8CF]/10 px-2.5 py-1 rounded-full mt-1 ml-1"
                    >
